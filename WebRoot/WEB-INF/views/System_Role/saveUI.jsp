...
<body>
	...
	<div id="MainArea">
		<form
			action="${pageContext.request.contextPath }/role_${model.id==null?'add':'update'}_action.action"
				...
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td><input type="text" name="model.name" value="${model.name}"
								class="InputStyle" /> *</td>
						</tr>
						<tr>
							<td>岗位说明</td>
							<td><textarea name="model.description" class="TextareaStyle">${model.description}</textarea>
							</td>
						</tr>
					</table>
				</div>
