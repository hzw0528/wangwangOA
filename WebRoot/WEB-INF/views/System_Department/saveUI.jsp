...
<body>
	...
	<div id=MainArea>
		<form
			action="${pageContext.request.contextPath}/depart_${id==null?'add':'update'}_action.action"
			method="post">
				...
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
                            ...
                            </select> --> <s:select list="#departments" name="parentId"
									cssClass="SelectStyle" listKey="id" listValue="name" headerKey=""
									headerValue="--请选择部门--">
								</s:select>
							</td>
						</tr>
						<tr>
							<td>部门名称</td>
							<td><input type="text" name="department.name"
								class="InputStyle" value="${department.name }" /> *</td>
						</tr>
						<tr>
							<td>职能说明</td>
							<td><textarea name="department.description"
									class="TextareaStyle">${department.description }</textarea></td>
						</tr>
					</table>
				</div>
			</div>
